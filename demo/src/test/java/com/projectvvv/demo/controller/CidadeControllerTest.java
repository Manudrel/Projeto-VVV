...
class CidadeControllerTest {
    ...
    @Test
    @DisplayName("GET /api/cidade - Deve retornar a lista de todas as cidades e status 200")
    ...
    @Test
    @DisplayName("GET /api/cidade/{id} - Deve retornar uma cidade por ID e status 200")
    ...
    @Test
    @DisplayName("PUT /api/cidade/{id} - Deve atualizar os dados da cidade e retornar status 200")
    ...
    @Test
    @DisplayName("DELETE /api/cidade/{id} - Deve chamar a exclusão do service e retornar status 200")
